...
import com.tencent.angel.sona.ml.param.{DoubleParam, ParamMap, ParamValidators}
...
/**
  ...
  */
private[sona] trait TrainValidationSplitParams extends ValidatorParams {
  /**
...
class TrainValidationSplit(override val uid: String)
...
class TrainValidationSplitModel private[sona](
  ...
  private[sona] def this(uid: String, bestModel: Model[_], validationMetrics: JList[Double]) = {
