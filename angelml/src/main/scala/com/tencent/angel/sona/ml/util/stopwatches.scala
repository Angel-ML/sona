...
/**
  ...
  */
private[sona] abstract class Stopwatch extends Serializable {
...
/**
  * A local [[Stopwatch]].
  */
private[sona] class LocalStopwatch(override val name: String) extends Stopwatch {
...
/**
  ...
  */
private[sona] class DistributedStopwatch(sc: SparkContext, override val name: String) extends Stopwatch {
...
/**
  ...
  * @param sc SparkContext
  */
private[sona] class MultiStopwatch(@transient private val sc: SparkContext) extends Serializable {
