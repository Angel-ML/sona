...
import com.tencent.angel.sona.ml.{PredictionModel, Predictor, PredictorParams}
...
/**
  ...
  */
private[sona] abstract class Regressor[FeaturesType, Learner <: Regressor[FeaturesType, Learner, M], M <: RegressionModel[FeaturesType, M]]
