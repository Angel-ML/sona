...
sealed abstract class Attribute extends Serializable {
  ...
  /**
    ...
    */
  private[sona] def toMetadataImpl(withType: Boolean): Metadata
  ...
  /**
    ...
    */
  private[sona] def toMetadataImpl(): Metadata = {
...
private[sona] trait AttributeFactory {

  /**
    * Creates an [[Attribute]] from a [[Metadata]] instance.
    */
  private[sona] def fromMetadata(metadata: Metadata): Attribute
...
object Attribute extends AttributeFactory {
  ...
  private[sona] override def fromMetadata(metadata: Metadata): Attribute = {
...
class NumericAttribute private[angel](
  ...
  override private[sona] def toMetadataImpl(withType: Boolean): Metadata = {
    import AttributeKeys._
...
object NumericAttribute extends AttributeFactory {
  ...
  private[sona] override def fromMetadata(metadata: Metadata): NumericAttribute = {
    import AttributeKeys._
...
object NominalAttribute extends AttributeFactory {
  ...
  private[sona] override def fromMetadata(metadata: Metadata): NominalAttribute = {
    import AttributeKeys._
    val name = if (metadata.contains(NAME)) Some(metadata.getString(NAME)) else None
    val index = if (metadata.contains(INDEX)) Some(metadata.getLong(INDEX)) else None
...
object BinaryAttribute extends AttributeFactory {
  ...
  private[sona] override def fromMetadata(metadata: Metadata): BinaryAttribute = {
    import AttributeKeys._
    val name = if (metadata.contains(NAME)) Some(metadata.getString(NAME)) else None
    val index = if (metadata.contains(INDEX)) Some(metadata.getLong(INDEX)) else None
    val values =
