...
import com.tencent.angel.sona.ml.param.{DoubleParam, ParamMap, Params}
...
/**
  ...
  */
private[sona] trait MinMaxScalerParams extends Params with HasInputCol with HasOutputCol {
...
class MinMaxScalerModel private[angel](
                                        ...
                                        val originalMin: linalg.Vector,
                                        val originalMax: linalg.Vector)
