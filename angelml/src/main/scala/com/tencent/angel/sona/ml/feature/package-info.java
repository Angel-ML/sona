 ...
 * Most feature transformers are implemented as {@link com.tencent.angel.sona.ml.Transformer}s, which
 * transforms one {@link org.apache.spark.sql.Dataset} into another, e.g.,
 * Some feature transformers are implemented as {@link com.tencent.angel.sona.ml.Estimator}}s, because the
 * transformation requires some aggregated information of the dataset, e.g., document
 * For those feature transformers, calling {@link com.tencent.angel.sona.ml.Estimator#fit} is required to
 ...
 * {@link com.tencent.angel.sona.ml.Pipeline} can be used to chain feature transformers, and
 * {@link com.tencent.angel.sona.ml.feature.VectorAssembler} can be used to combine multiple feature
