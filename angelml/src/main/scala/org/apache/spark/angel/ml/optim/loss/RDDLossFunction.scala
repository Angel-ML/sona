 ...
 */
package org.apache.spark.angel.ml.optim.loss

import scala.reflect.ClassTag
import breeze.linalg.{DenseVector => BDV}
import breeze.optimize.DiffFunction
import org.apache.spark.angel.ml.linalg
import org.apache.spark.angel.ml.linalg.{BLAS, Vectors}
import org.apache.spark.angel.ml.optim.aggregator.DifferentiableLossAggregator
...
private[angelml] class RDDLossFunction[
    ...
    Agg <: DifferentiableLossAggregator[T, Agg]: ClassTag](
                                                            instances: RDD[T],
                                                            getAggregator: (Broadcast[linalg.Vector] => Agg),
                                                            regularization: Option[DifferentiableRegularization[linalg.Vector]],
