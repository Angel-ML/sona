...
import org.apache.spark.angel.ml.linalg.{IntSparseVector, LongSparseVector, VectorUDT, Vectors}
import org.apache.spark.angel.ml.param.ParamMap
import org.apache.spark.angel.ml.param.shared.HasSeed
import org.apache.spark.angel.ml.util.{DefaultParamsReadable, DefaultParamsReader, DefaultParamsWriter, Identifiable, MLReadable, MLReader, MLWriter, SchemaUtils}
...
class MinHashLSHModel private[angelml](
  ...
  @Since("2.1.0")
  override protected[angelml] def hashFunction(elems: linalg.Vector): Array[linalg.Vector] = {
  ...
  @Since("2.1.0")
  override protected[angelml] def keyDistance(x: linalg.Vector, y: linalg.Vector): Double = {
  ...
  @Since("2.1.0")
  override protected[angelml] def hashDistance(x: Seq[linalg.Vector], y: Seq[linalg.Vector]): Double = {
