...
class MultivariateOnlineSummarizer extends MultivariateStatisticalSummary with Serializable {
   ...
   */
  @Since("1.1.0")
  def add(sample: linalg.Vector): this.type = add(sample, 1.0)

  private[spark] def add(instance: linalg.Vector, weight: Double): this.type = {
   ...
   */
  @Since("1.1.0")
  override def mean: linalg.Vector = {
   ...
   */
  @Since("1.1.0")
  override def variance: linalg.Vector = {
    require(totalWeightSum > 0, s"Nothing has been added to this summarizer.")
   ...
   */
  @Since("1.1.0")
  override def numNonzeros: linalg.Vector = {
   ...
   */
  @Since("1.1.0")
  override def max: linalg.Vector = {
    require(totalWeightSum > 0, s"Nothing has been added to this summarizer.")
   ...
   */
  @Since("1.1.0")
  override def min: linalg.Vector = {
    require(totalWeightSum > 0, s"Nothing has been added to this summarizer.")
   ...
   */
  @Since("1.2.0")
  override def normL2: linalg.Vector = {
    require(totalWeightSum > 0, s"Nothing has been added to this summarizer.")
   ...
   */
  @Since("1.2.0")
  override def normL1: linalg.Vector = {
    require(totalWeightSum > 0, s"Nothing has been added to this summarizer.")
