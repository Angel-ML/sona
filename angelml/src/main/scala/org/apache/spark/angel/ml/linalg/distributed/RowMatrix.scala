...
package org.apache.spark.angel.ml.linalg.distributed
...
import org.apache.spark.angel.ml.linalg.{BLAS, DenseMatrix, DenseVector, EigenValueDecomposition, IntSparseVector, Matrices, Matrix, QRDecomposition, SingularValueDecomposition, Vectors}
import org.apache.spark.angel.ml.stat.{MultivariateOnlineSummarizer, MultivariateStatisticalSummary}
...
class RowMatrix @Since("1.0.0") (
                                  @Since("1.0.0") val rows: RDD[linalg.Vector],
