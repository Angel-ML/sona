...
import org.apache.spark.angel.ml.{Transformer, linalg}
import org.apache.spark.angel.ml.attribute.{Attribute, AttributeGroup, NumericAttribute, UnresolvedAttribute}
import org.apache.spark.angel.ml.linalg.{VectorUDT, Vectors}
import org.apache.spark.angel.ml.param.{Param, ParamMap, ParamValidators}
import org.apache.spark.angel.ml.param.shared.{HasHandleInvalid, HasInputCols, HasOutputCol}
...
object VectorAssembler extends DefaultParamsReadable[VectorAssembler] {
   ...
   */
  private[feature] def assembleInt(lengths: Array[Int], keepInvalid: Boolean)(vv: Any*): linalg.Vector = {
  ...
  private[feature] def assembleLong(lengths: Array[Long], keepInvalid: Boolean)(vv: Any*): linalg.Vector = {
