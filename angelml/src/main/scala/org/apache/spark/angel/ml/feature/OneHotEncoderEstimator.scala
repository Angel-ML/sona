...
import org.apache.spark.angel.ml.param.{BooleanParam, Param, ParamMap, ParamValidators, Params}
import org.apache.spark.angel.ml.param.shared.{HasHandleInvalid, HasInputCols, HasOutputCols}
...
private[angelml] trait OneHotEncoderBase extends Params with HasHandleInvalid
 ...
 */
@Since("2.3.0")
class OneHotEncoderModel private[angelml](
