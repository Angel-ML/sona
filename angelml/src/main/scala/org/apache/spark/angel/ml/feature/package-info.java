 ...
 * Most feature transformers are implemented as {@link org.apache.spark.angel.ml.Transformer}s, which
 * transforms one {@link org.apache.spark.sql.Dataset} into another, e.g.,
 * Some feature transformers are implemented as {@link org.apache.spark.angel.ml.Estimator}}s, because the
 * transformation requires some aggregated information of the dataset, e.g., document
 * For those feature transformers, calling {@link org.apache.spark.angel.ml.Estimator#fit} is required to
 * obtain the model first, in order to apply
 * transformation.
 ...
 * {@link org.apache.spark.angel.ml.Pipeline} can be used to chain feature transformers, and
 * {@link org.apache.spark.angel.ml.feature.VectorAssembler} can be used to combine multiple feature
