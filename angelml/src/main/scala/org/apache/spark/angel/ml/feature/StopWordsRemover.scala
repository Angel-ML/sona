...
import org.apache.spark.angel.ml.param.{BooleanParam, Param, ParamMap, ParamValidators, StringArrayParam}
...
object StopWordsRemover extends DefaultParamsReadable[StopWordsRemover] {
  ...
  def loadDefaultStopWords(language: String): Array[String] = {
    ...
    val is = getClass.getResourceAsStream(s"/org/apache/spark/angel/ml/feature/stopwords/$language.txt")
