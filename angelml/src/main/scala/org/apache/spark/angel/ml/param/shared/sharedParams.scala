...
import org.apache.spark.angel.ml.clustering
import org.apache.spark.angel.ml.clustering.DistanceMeasure
...
trait HasNumEpoch extends Params {
  final val numEpoch: IntParam = new IntParam(this, "numEpoch", "numEpoch", ParamValidators.gtEq(0))
...
/**
 * Trait for shared param distanceMeasure (default: org.apache.spark.ml.clustering.DistanceMeasure.EUCLIDEAN). This trait may be changed or
 * removed between minor versions.
 */
@DeveloperApi
trait HasDistanceMeasure extends Params {
   ...
   * @group param
   */
  final val distanceMeasure: Param[String] = new Param[String](this,
    "distanceMeasure", "The distance measure. Supported options: 'euclidean' and 'cosine'",
    (value: String) => DistanceMeasure.validateDistanceMeasure(value))

  setDefault(distanceMeasure, clustering.DistanceMeasure.EUCLIDEAN)
