...
import org.apache.spark.angel.graph.line.LINEPSModel.{LINEDataSet, buildDataBatches}
...
class LINEModel(numNode: Int,
  ...
  def negativeSample(nodeIds: Array[Int], sampleNum: Int, seed: Int): Array[Array[Int]] = {
