...
package org.apache.spark.angel.ml.rdd

import org.apache.spark.angel.ml.linalg
import scala.reflect.ClassTag
import scala.util.Random
import org.apache.spark.{Partition, SparkContext, TaskContext}
import org.apache.spark.angel.ml.linalg.{DenseVector, Vector}
import org.apache.spark.angel.ml.random.RandomDataGenerator
...
private[angelml] class RandomVectorRDD(sc: SparkContext,
                                       ...
                                       @transient private val seed: Long = Utils.random.nextLong) extends RDD[linalg.Vector](sc, Nil) {
