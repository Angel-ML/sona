...
object GradientDescent extends Logging {
  ...
  def runMiniBatchSGD(
                       ...
                       initialWeights: linalg.Vector,
                       convergenceTol: Double): (linalg.Vector, Array[Double]) = {
    ...
    var previousWeights: Option[linalg.Vector] = None
    var currentWeights: Option[linalg.Vector] = None
    ...
    var regVal = updater.compute(
      weights, Vectors.zeros(weights.size.toInt), 0, 1, regParam)._2
  ...
  def runMiniBatchSGD(
                       ...
                       regParam: Double,
                       miniBatchFraction: Double,
                       initialWeights: linalg.Vector): (linalg.Vector, Array[Double]) =
  ...
  private def isConverged(
                           previousWeights: linalg.Vector,
                           currentWeights: linalg.Vector,
