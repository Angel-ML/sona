 ...
 */
 private[angel] trait BucketedRandomProjectionLSHParams extends Params {
...
@Experimental
@Since("2.1.0")
class BucketedRandomProjectionLSHModel private[angel](
    override val uid: String,
    private[angel] val randUnitVectors: Array[linalg.Vector])
