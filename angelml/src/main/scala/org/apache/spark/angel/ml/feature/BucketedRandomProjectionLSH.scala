 ...
 */
private[angelml] trait BucketedRandomProjectionLSHParams extends Params {
...
@Experimental
@Since("2.1.0")
class BucketedRandomProjectionLSHModel private[angelml](
    override val uid: String,
    private[angelml] val randUnitVectors: Array[linalg.Vector])
