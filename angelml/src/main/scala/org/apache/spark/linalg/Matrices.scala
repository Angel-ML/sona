...
sealed trait Matrix extends Serializable {
  ...
  /**
    ...
    */
  def toSparseMatrix(colMajor: Boolean): SparseMatrix
  ...
  /**
    ...
    *                 or row major order. If `false`, resulting matrix will be row major.
    */
  def toDenseMatrix(colMajor: Boolean): DenseMatrix
...
class DenseMatrix(
  ...
  /**
    ...
    */
  override def toSparseMatrix(colMajor: Boolean): SparseMatrix = {
  ...
  /**
    ...
    */
  override def toDenseMatrix(colMajor: Boolean): DenseMatrix = {
  ...
  def getSizeInBytes: Long = Matrices.getDenseSize(numCols, numRows)
}
...
class SparseMatrix(
  ...
  override def colIter: Iterator[Vector] = {
    if (isTransposed) {
      ...
      Iterator.tabulate(numCols) { j =>
        ...
        new IntSparseVector(numRows, ii, vv)
      }
    } else {
      Iterator.tabulate(numCols) { j =>
  ...
  def getSizeInBytes: Long = Matrices.getSparseSize(numActives, colPtrs.length)
}
...
object Matrices {
  ...
  def getSparseSize(numActives: Long, numPtrs: Long): Long = {
    /*
  ...
  def getDenseSize(numCols: Long, numRows: Long): Long = {
    /*
