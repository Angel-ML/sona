...
import org.apache.spark.angelml.feature.{Instance, OffsetInstance}
...
@Experimental
@Since("2.0.0")
class GeneralizedLinearRegressionModel private[angelml](
...
class GeneralizedLinearRegressionSummary private[regression] (
   ...
   */
  private[angelml] lazy val featureNames: Array[String] = {
...
class GeneralizedLinearRegressionTrainingSummary private[regression] (
   ...
   */
  private[angelml] val isNormalSolver: Boolean = {
   ...
   */
  private[angelml] lazy val coefficientsWithStatistics: Array[
