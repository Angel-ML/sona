...
import org.apache.spark.angelml.ann.{FeedForwardTopology, FeedForwardTrainer}
import org.apache.spark.angelml.feature.OneHotEncoderModel
 ...
 */
@Since("1.5.0")
class MultilayerPerceptronClassificationModel private[angelml](
    @Since("1.5.0") override val uid: String,
  ...
  private[angelml] val mlpModel = FeedForwardTopology
   ...
   */
  private[angelml] def javaLayers: java.util.List[Int] = {
