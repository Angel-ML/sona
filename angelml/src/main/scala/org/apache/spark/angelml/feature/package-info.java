 ...
 * Most feature transformers are implemented as {@link org.apache.spark.angelml.Transformer}s, which
 * transforms one {@link org.apache.spark.sql.Dataset} into another, e.g.,
 * Some feature transformers are implemented as {@link org.apache.spark.angelml.Estimator}}s, because the
 * transformation requires some aggregated information of the dataset, e.g., document
 * For those feature transformers, calling {@link org.apache.spark.angelml.Estimator#fit} is required to
 ...
 * {@link org.apache.spark.angelml.Pipeline} can be used to chain feature transformers, and
 * {@link org.apache.spark.angelml.feature.VectorAssembler} can be used to combine multiple feature
