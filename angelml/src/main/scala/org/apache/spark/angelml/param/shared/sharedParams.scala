...
trait HasDistanceMeasure extends Params {
  ...
  final val distanceMeasure: Param[String] = new Param[String](this,
    ...
    (value: String) => org.apache.spark.angelml.clustering.DistanceMeasure.validateDistanceMeasure(value))

  setDefault(distanceMeasure, org.apache.spark.angelml.clustering.DistanceMeasure.EUCLIDEAN)
