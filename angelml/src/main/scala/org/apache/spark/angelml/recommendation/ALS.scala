...
package org.apache.spark.angelml.recommendation
...
import org.apache.spark.angelml.linalg.BLAS
...
import org.apache.spark.angelml.linalg.CholeskyDecomposition
import org.apache.spark.angelml.optim.NNLS
...
class ALS(@Since("1.4.0") override val uid: String) extends Estimator[ALSModel] with ALSParams
  ...
  import org.apache.spark.angelml.recommendation.ALS.Rating
