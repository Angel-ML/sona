...
import org.apache.spark.angelml.linalg.{Matrix, Vector}
import org.apache.spark.angelml.linalg.distributed.RowMatrix
import org.apache.spark.angelml.stat.correlation.Correlations
import org.apache.spark.angelml.stat.test.{ChiSqTest, ChiSqTestResult, KolmogorovSmirnovTest, KolmogorovSmirnovTestResult}
 ...
 *
   ...
   * @return [[org.apache.spark.angelml.stat.test.KolmogorovSmirnovTestResult]] object containing test
