...
import org.apache.spark.angelml.classification.{OneVsRest, OneVsRestModel}
import org.apache.spark.angelml.feature.RFormulaModel
import org.apache.spark.angelml.param.{ParamPair, Params}
import org.apache.spark.angelml.tuning.ValidatorParams
 ...
 * all data as [[org.apache.spark.angelml.param.Param]] values, then extending this trait will provide
 * a default implementation of writing saved instances of the class.
 * This only handles simple [[org.apache.spark.angelml.param.Param]] types; e.g., it will not handle
...
private[angelml] object DefaultParamsWriter {
   ...
   *                      Otherwise, all [[org.apache.spark.angelml.param.Param]]s are encoded using
   *                      [[org.apache.spark.angelml.param.Param.jsonEncode()]].
   */
  def saveMetadata(
      instance: Params,
      path: String,
...
private[angelml] object DefaultParamsReader {
  ...
  case class Metadata(
    ...
    /**
     * Get the JSON value of the [[org.apache.spark.angelml.param.Param]] of the given name.
     ...
     * [[org.apache.spark.angelml.param.Param.jsonDecode()]].
     *
     * @param skipParams The params included in `skipParams` won't be set. This is useful if some
     *                   params don't implement [[org.apache.spark.angelml.param.Param.jsonDecode()]]
