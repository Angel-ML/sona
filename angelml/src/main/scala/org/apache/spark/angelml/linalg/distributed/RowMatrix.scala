...
import org.apache.spark.angelml.stat.{MultivariateOnlineSummarizer, MultivariateStatisticalSummary}
...
class RowMatrix @Since("1.0.0") (
   ...
   * @return a [[org.apache.spark.angelml.linalg.distributed.RowMatrix]] representing the product,
