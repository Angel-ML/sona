...
private[evaluation] object SquaredEuclideanSilhouette extends Silhouette {
   ...
   * [[org.apache.spark.angelml.evaluation.SquaredEuclideanSilhouette.ClusterStats]]
   ...
   * @param point                  The [[org.apache.spark.angelml.linalg.Vector]] representing the current point.
...
private[evaluation] object CosineSilhouette extends Silhouette {
   ...
   *
   * @param broadcastedClustersMap A map of the precomputed values for each cluster.
   * @param normalizedFeatures     The [[org.apache.spark.angelml.linalg.Vector]] representing the
