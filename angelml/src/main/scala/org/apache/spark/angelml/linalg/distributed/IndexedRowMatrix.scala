...
package org.apache.spark.angelml.linalg.distributed

import breeze.linalg.{DenseMatrix => BDM}

import org.apache.spark.annotation.Since
import org.apache.spark.angelml.linalg._
import org.apache.spark.angelml.linalg.SingularValueDecomposition
import org.apache.spark.rdd.RDD

/**
 * Represents a row of [[org.apache.spark.angelml.linalg.distributed.IndexedRowMatrix]].
 */
@Since("1.0.0")
case class IndexedRow(index: Long, vector: Vector)

/**
 * Represents a row-oriented [[org.apache.spark.angelml.linalg.distributed.DistributedMatrix]] with
 * indexed rows.
 *
...
class IndexedRowMatrix @Since("1.0.0") (
   ...
   * [[org.apache.spark.angelml.linalg.distributed.RowMatrix]].
   */
  @Since("1.0.0")
   ...
   * [[org.apache.spark.angelml.linalg.distributed.CoordinateMatrix]].
   */
  @Since("1.3.0")
   ...
   *
   * U is an [[org.apache.spark.angelml.linalg.distributed.IndexedRowMatrix]] of size m x k that
   * satisfies U'U = eye(k),
