...
import com.tencent.angel.sona.ml.util.{DefaultReadWriteTest, MLTest, MLTestingUtils}
...
class StandardScalerSuite extends MLTest with DefaultReadWriteTest {
  ...
  @transient var resWithStd: Array[linalg.Vector] = _
  @transient var resWithMean: Array[linalg.Vector] = _
  @transient var resWithBoth: Array[linalg.Vector] = _
  ...
  def assertResult: Row => Unit = {
    case Row(vector1: linalg.Vector, vector2: linalg.Vector) =>
  ...
  test("Standardization with default parameter") {
    ...
    testTransformer[(linalg.Vector, linalg.Vector)](df0, standardScaler0, "standardized_features", "expected")(
      assertResult)
  }
  ...
  test("Standardization with setter") {
    ...
    testTransformer[(linalg.Vector, linalg.Vector)](df1, standardScaler1, "standardized_features", "expected")(
      assertResult)
    testTransformer[(linalg.Vector, linalg.Vector)](df2, standardScaler2, "standardized_features", "expected")(
      assertResult)
    testTransformer[(linalg.Vector, linalg.Vector)](df3, standardScaler3, "standardized_features", "expected")(
      assertResult)
  }
  ...
  test("sparse data and withMean") {
    ...
    val standardScaler = new StandardScaler()
      ...
      .setWithStd(false)
      .fit(df)
    testTransformer[(linalg.Vector, linalg.Vector)](df, standardScaler, "standardized_features", "expected")(
      assertResult)
  }
