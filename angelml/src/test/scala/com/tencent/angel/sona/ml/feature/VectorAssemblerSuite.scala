...
import com.tencent.angel.sona.ml.attribute.{Attribute, AttributeGroup, NominalAttribute, NumericAttribute}
import org.apache.spark.linalg
import org.apache.spark.linalg.{DenseVector, IntSparseVector, Vectors}
import com.tencent.angel.sona.ml.util.{DefaultReadWriteTest, MLlibTestSparkContext}
import org.apache.spark.{SparkException, SparkFunSuite}
import org.apache.spark.sql.{Dataset, Row}
import org.apache.spark.sql.functions.{col, udf}
import org.apache.spark.util.DatasetUtil

class VectorAssemblerSuite extends SparkFunSuite with MLlibTestSparkContext with DefaultReadWriteTest {
  ...
  override def beforeAll(): Unit = {
    ...
    dfWithNullsAndNaNs = Seq[(Long, Long, java.lang.Double, linalg.Vector, String, linalg.Vector, Long, String)](
  ...
  test("assemble") {
    import VectorAssembler.assembleInt
  ...
  test("SPARK-22446: VectorAssembler's UDF should not apply on filtered data") {
    ...
    val vectorUDF = udf { vector: linalg.Vector =>
      vector.numActives
    }
  ...
  test("Handle Invalid should behave properly") {
    ...
    def runWithMetadata(mode: String, additional_filter: String = "true"): Dataset[_] = {
      ...
      val dfWithMetadata1 = DatasetUtil.withColumn(dfWithNullsAndNaNs, "y", col("y"), attributeY.toMetadata)
      val dfWithMetadata2 = DatasetUtil.withColumn(dfWithMetadata1, "z", col("z"), attributeZ.toMetadata)
      val dfWithMetadata = dfWithMetadata2.filter(additional_filter)
