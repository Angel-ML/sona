...
import org.apache.spark.angelml.classification.MultiClassSummarizer
...
object DifferentiableLossAggregatorSuite {
  ...
  private[angelml] def getRegressionSummarizers(
  ...
  /** Get feature and label summarizers for provided data. */
  private[angelml] def getClassificationSummarizers(
