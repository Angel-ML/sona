...
//    driverCtx.startAngelAndPSAgent()
    ...
    val svm_classifier = new AngelClassifier()
      .setModelJsonFile("E:\\angel-things\\fitzwang\\sona\\angelml\\src\\test\\jsons\\svm.json")
      .setNumClass(2)
      .setNumBatch(10)
      .setMaxIter(2)
      .setLearningRate(0.1)
...
//    driverCtx.startAngelAndPSAgent()
    ...
    val classifier = new AngelClassifier()
      .setModelJsonFile("E:\\angel-things\\fitzwang\\sona\\angelml\\src\\test\\jsons\\softmax.json")
      .setNumClass(2)
      .setNumBatch(10)
      .setMaxIter(2)
      .setLearningRate(0.1)
...
//    driverCtx.startAngelAndPSAgent()
    ...
    val classifier = new AngelClassifier()
      .setModelJsonFile("E:\\angel-things\\fitzwang\\sona\\angelml\\src\\test\\jsons\\robustreg.json")
      .setNumClass(2)
      .setNumBatch(10)
      .setMaxIter(2)
      .setLearningRate(0.1)
...
//    driverCtx.startAngelAndPSAgent()
    ...
    val classifier = new AngelClassifier()
      .setModelJsonFile("E:\\angel-things\\fitzwang\\sona\\angelml\\src\\test\\jsons\\mixedlr.json")
      .setNumClass(2)
      .setNumBatch(10)
      .setMaxIter(2)
      .setLearningRate(0.1)
...
//    driverCtx.startAngelAndPSAgent()
    ...
    val deepfm_classifier = new AngelClassifier()
      .setModelJsonFile("E:\\angel-things\\fitzwang\\sona\\angelml\\src\\test\\jsons\\deepfm.json")
      .setNumClass(2)
      .setNumBatch(10)
      .setMaxIter(2)
      .setLearningRate(0.1)
